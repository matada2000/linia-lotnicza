...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            'name' => 'Robert',
            'surname' => 'Zieliński',
            'email' => 'RobertZielinski@gmail.com',
            'role' => 3,
            'email_verified_at' => now(),
            'password' => Hash::make('RobertZielinski'),
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'remember_token' => Str::random(10),
        ]);
        ...
        DB::table('users')->insert([
            'name' => 'Adam',
            'surname' => 'Kamiński',
            'email' => 'AdamKaminski@gmail.com',
            'role' => 3,
            'email_verified_at' => now(),
            'password' => Hash::make('AdamKaminski'),
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'remember_token' => Str::random(10),
        ]);
        DB::table('users')->insert([
            'name' => 'Mariusz',
            'surname' => 'Jop',
            'email' => 'MariuszJop@gmail.com',
            'role' => 3,
            'email_verified_at' => now(),
            'password' => Hash::make('MariuszJop'),
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'remember_token' => Str::random(10),
        ]);
        DB::table('users')->insert([
            'name' => 'Maciej',
            'surname' => 'Kowalczyk',
            'email' => 'MaciejKowalczyk@gmail.com',
            'role' => 3,
            'email_verified_at' => now(),
            'password' => Hash::make('MaciejKowalczyk'),
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now(),
            'remember_token' => Str::random(10),
        ]);
