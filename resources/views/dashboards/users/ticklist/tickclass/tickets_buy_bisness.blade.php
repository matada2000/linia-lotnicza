  ...
  <table class="table">
    <tbody>
      <tr>
        ...
        <td>
            <input style="width: 50%; background-color: lightgray;" id="class" name="class" class="form-control @error('class') is-invalid @enderror" value="Biznesowy" disabled>
        </td>
      </tr>
    </tbody>
    <tbody>
    ...
    <tbody>
      <tr>
        ...
        <td>
            <input style="width: 50%; background-color: lightgray;" id="class" name="class" class="form-control @error('class') is-invalid @enderror" value="bisness" hidden>
