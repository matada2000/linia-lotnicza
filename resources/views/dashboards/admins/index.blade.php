...
<div class="d-flex d-flex2 h-100 text-center text-white bg-dark">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <p class="lead">Przemieszczaj sie po panelach, aby sprytnie dokonywać operacje na bazie danych lini lotniczych. Pamiętaj, po skończonej pracy wyloguj się dla bezpieczeństwa.</p>
