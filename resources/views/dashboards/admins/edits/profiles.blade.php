...
<br>
<h1 style="font-family: Courier, 'Lucida Console', monospace"><center>Edycja Admina</center></h1>
<br>
...
<table class="table">
    ...
    <tbody>
        <tr>
          ...
          <button style="background-color:DodgerBlue;"><a style="color: white;" href="/admin/profiles">Anuluj</a></button>
          </form>
          </td>
